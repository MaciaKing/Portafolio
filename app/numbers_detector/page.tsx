...
export default function NumbersDetectorPage() {
    ...
    const sendToAI = async () => {
        ...
        const res = await fetch("http://portfolio-ai:8000/predict", {
            method: "POST",
    ...
    return (
        <main className="flex flex-col items-center gap-4 p-8 text-gray-900 dark:text-white bg-white dark:bg-gray-900 min-h-screen">
